...
func (_Router *RouterCaller) SwapMining(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Router.contract.Call(opts, &out, "swapMining")
...
//
// Solidity: function swapMining() view returns(address)
func (_Router *RouterSession) SwapMining() (common.Address, error) {
	return _Router.Contract.SwapMining(&_Router.CallOpts)
}

// SwapMining is a free data retrieval call binding the contract method 0x4e5eda11.
//
// Solidity: function swapMining() view returns(address)
func (_Router *RouterCallerSession) SwapMining() (common.Address, error) {
	return _Router.Contract.SwapMining(&_Router.CallOpts)
}
...
func (_Router *RouterTransactor) SetSwapMining(opts *bind.TransactOpts, _swapMininng common.Address) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "setSwapMining", _swapMininng)
}

// SetSwapMining is a paid mutator transaction binding the contract method 0x4f887183.
//
// Solidity: function setSwapMining(address _swapMininng) returns()
func (_Router *RouterSession) SetSwapMining(_swapMininng common.Address) (*types.Transaction, error) {
	return _Router.Contract.SetSwapMining(&_Router.TransactOpts, _swapMininng)
}

// SetSwapMining is a paid mutator transaction binding the contract method 0x4f887183.
//
// Solidity: function setSwapMining(address _swapMininng) returns()
func (_Router *RouterTransactorSession) SetSwapMining(_swapMininng common.Address) (*types.Transaction, error) {
	return _Router.Contract.SetSwapMining(&_Router.TransactOpts, _swapMininng)
}
